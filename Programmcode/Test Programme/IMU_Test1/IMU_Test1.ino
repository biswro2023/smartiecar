...
//--------------------------------ab hier NPC Loop Luke-------------------------------------------------
 ...
 //ruft Ausrichtungsfunktion auf
  ...
  if ((Abstand_L > 60) && (FR == 'K'))
  {
    FR = 'L';
    lcd.setCursor(0,0);
    lcd.print(FR);
  }
  if ((Abstand_R > 60) && (FR == 'K'))
  {
    FR = 'R';
    lcd.setCursor(0,0);
    lcd.print(FR);
  ...
  if ((Abstand_L > 60) && (FR == 'L'))
  {
    
        Kurve_L();
        runMotor(NormG);
  }
  else if ((Abstand_R > 60) && (FR == 'R'))
  {
        Kurve_R();
        runMotor(NormG);
  }
