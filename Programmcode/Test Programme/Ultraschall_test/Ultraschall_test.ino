#define trigger A0 //Trigger-Pin des Ultraschallsensors an Pin7 des Arduino-Boards 
#define echo A1 // Echo-Pim des Ultraschallsensors an Pin6 des Arduino-Boards 
