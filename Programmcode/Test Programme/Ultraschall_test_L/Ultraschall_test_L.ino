#define trigger 8 //Trigger-Pin des Ultraschallsensors an Pin7 des Arduino-Boards 
#define echo 9 // Echo-Pim des Ultraschallsensors an Pin6 des Arduino-Boards 
