#define trigger A2 //Trigger-Pin des Ultraschallsensors an Pin7 des Arduino-Boards 
#define echo A3 // Echo-Pim des Ultraschallsensors an Pin6 des Arduino-Boards 
